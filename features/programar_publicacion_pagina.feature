Feature: Función programar publicación de una página
  @user1 @web
  Scenario: Programar publicación de una página
    ...
    Then I enter "Programar publicación de una página con KRAKEN" into input field having css selector ".gh-editor-title"
